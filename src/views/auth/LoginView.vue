    ...
    <v-container fluid>
      <v-row class="fill-height" align="center" justify="center">
        ...
        <v-col
          cols="12"
          md="6"
          class="text-white px-12 d-flex flex-column justify-center"
          v-show="!mobile"
        >
          <div
            class="fade-in-text"
          ...
          >
            <h1 style="font-family: 'Playfair Display', serif; font-size: 40px">
              Welcome to MealSavers
            </h1>
            <p class="mt-4" style="font-size: 18px">
              Join a community that believes in sharing, reducing waste, and making a difference one
              meal at a time.
            </p>
            <p class="mt-2" style="font-size: 16px">
              Save food. Help others. Be a MealSaver today.
            </p>
          </div>
        </v-col>
          ...
          >
            <v-card-title class="text-center">
              ...
              <h3
                ...
                style="font-family: 'Playfair Display', serif; font-weight: 500; font-size: 28px"
              >
                MealSavers
              </h3>
            </v-card-title>
